...
#only useful for me...
mv /Users/Sean/Downloads/os.txt /Users/Sean/Documents/CrossWorks\ Projects/Calchack_F4/os.txt
cd /Users/Sean/Documents/CrossWorks\ Projects/Calchack_F4
...
echo "uint8_t os_image[OS_SIZE+2] = {OS_SIZE & 0xFF, (OS_SIZE >> 8) & 0xff," >> os.h
cat os.txt >> os.h
